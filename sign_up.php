    ...
    <main>
        ...
        <form action="sign_up.php" method="post">
            ...
            <div class="input">
                ...
                <input type="text" class="fas" name="name" placeholder="Name" autofocus required>
            </div>
            <div class="input">
                <i class="fas fa-envelope"></i>
                <input type="email" class="fas" name="email" placeholder="Gmail" required>
            </div>
            <div class="input">
                <i class="fas fa-at"></i>
                <input type="text" class="fas" name="username" placeholder="Username" required>
            </div>
            <div class="input">
